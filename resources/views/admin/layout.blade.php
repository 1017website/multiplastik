    ...
    <div class="sidebar" id="sidebar">
        ...
        @php
            ...
            $faviconUrl = $siteFavicon
                ? (str_starts_with($siteFavicon, 'http')
                    ? $siteFavicon
                    : asset($siteFavicon))
                : null;
        @endphp
        ...
        <div class="sidebar-nav">
            ...
            <a href="{{ route('admin.dashboard') }}"
                class="{{ request()->routeIs('admin.dashboard') ? 'active' : '' }}"><i class="fas fa-chart-line"></i>
                Dashboard</a>
            <a href="{{ route('admin.analytics.index') }}"
                class="{{ request()->routeIs('admin.analytics.*') ? 'active' : '' }}"><i class="fas fa-chart-pie"></i>
                Analytics</a>

            <div class="nav-section">Konten</div>
            <a href="{{ route('admin.slides.index') }}"
                class="{{ request()->routeIs('admin.slides.*') ? 'active' : '' }}"><i class="fas fa-images"></i> Hero
                Slider</a>
            <a href="{{ route('admin.promos.index') }}"
                class="{{ request()->routeIs('admin.promos.*') ? 'active' : '' }}"><i class="fas fa-bullhorn"></i>
                Promo Bar</a>
            ...
            <a href="{{ route('admin.settings.index', 'general') }}"
                class="{{ request()->routeIs('admin.settings.*') ? 'active' : '' }}"><i class="fas fa-sliders-h"></i>
                Site Settings</a>
            <a href="{{ route('admin.cs.index') }}" class="{{ request()->routeIs('admin.cs.*') ? 'active' : '' }}"><i
                    class="fas fa-headset"></i> CS WhatsApp</a>
        ...
        <div class="sidebar-footer">
            <a href="{{ route('home') }}" target="_blank"
                style="color:#6b7280;text-decoration:none;display:flex;align-items:center;gap:10px;padding:9px 20px;font-size:13px;transition:color .15s;"
                onmouseover="this.style.color='#e8e9f0'" onmouseout="this.style.color='#6b7280'"><i
                    class="fas fa-external-link-alt" style="width:17px;font-size:12px;"></i> Lihat Website</a>
            <form action="{{ route('admin.logout') }}" method="POST">
                @csrf
                <button type="submit"
                    style="all:unset;cursor:pointer;width:100%;color:#6b7280;display:flex;align-items:center;gap:10px;padding:9px 20px;font-size:13px;transition:color .15s;"
                    onmouseover="this.style.color='#fca5a5'" onmouseout="this.style.color='#6b7280'">
