    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-footer">
            <a href="{{ route('home') }}" target="_blank"
                style="color:#3d4060;text-decoration:none;display:flex;align-items:center;gap:10px;padding:9px 20px;font-size:13px;"><i
                    class="fas fa-external-link-alt" style="width:17px;font-size:12px;"></i> Lihat Website</a>
            <form action="{{ route('admin.logout') }}" method="POST">
                @csrf
                <button type="submit"
                    style="all:unset;cursor:pointer;width:100%;color:#3d4060;display:flex;align-items:center;gap:10px;padding:9px 20px;font-size:13px;">
