...
<head>
  ...
  <script type="application/ld+json">{"@context":"https://schema.org","@type":"Organization","name":"{{ setting('site_title') }}","url":"{{ url('/') }}"@if(setting('site_logo')),"logo":"{{ media_url(setting('site_logo')) }}"@endif}</script>
...
<nav id="mainNav">
  ...
  <div class="nav-right">
    ...
    <a href="{{ wa_link() }}" target="_blank" class="nav-cta" style="text-decoration:none;font-family:'Barlow Condensed';font-weight:700;font-size:14px;text-transform:uppercase;"><i class="fab fa-whatsapp"></i> Chat</a>
...
<div class="nav-drawer" id="navDrawer">
  ...
  <a href="{{ wa_link() }}" target="_blank" class="drawer-cta"><i class="fab fa-whatsapp"></i> Chat WhatsApp</a>
</div>
...
<!-- ==================== WA FLOAT ==================== -->
<a href="{{ wa_link('Halo, saya ingin bertanya tentang produk Multi Plastik') }}" target="_blank" class="wa-float" title="Chat WhatsApp">
