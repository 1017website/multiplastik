...
<head>
    ...
    @if (setting('og_image'))
        <meta property="og:image" content="{{ media_url(setting('og_image')) }}" />
    @endif
    ...
    @php
        ...
        if (setting('site_logo')) {
            $ldData['logo'] = media_url(setting('site_logo'));
        }
    @endphp
...
<body>
    ...
    <footer>
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <div class="footer-social">
                    @if (setting('contact_instagram'))
                        <a href="{{ setting('contact_instagram') }}" target="_blank" title="Instagram"><i
                                class="fab fa-instagram"></i></a>
                    @endif
                    @if (setting('contact_facebook'))
            ...
            <div class="footer-col">
                <h4>Kontak</h4>
                <ul class="footer-links">
                    <li><a href="{{ wa_link() }}" target="_blank">{{ setting('contact_whatsapp_display') }}</a>
                    </li>
    ...
    <!-- ==================== WA FLOAT ==================== -->
    <a href="{{ wa_link('Halo, saya ingin bertanya tentang produk Multi Plastik') }}" target="_blank"
        class="wa-float" title="Chat WhatsApp">
            ...
            <form action="{{ route('site.search') }}" method="GET">
                <div class="search-input-wrap">
                    ...
                    <input type="text" name="q" id="searchInput" class="search-input"
                        placeholder="Cari produk: gelas, tusuk, sendok, styrofoam..." autocomplete="off">
                    <button type="button" class="search-close" onclick="closeSearch()"><i
